...
namespace DreamCar.ViewModels.VM
{
    public class ContactDetailsVm
    {
        ...
        [RegularExpression("^d{2}-d{3}$", ErrorMessage = "Podaj prawidłowy kod pocztowy")]
        public string ZipCode { get; set; }

        [StringLength(13, ErrorMessage = "Nr telefonu musi składać się z co najmniej {2} i maksymalnie {1} znaków.", MinimumLength = 11)]
        [RegularExpression("?([0-9]{2})[0-9]{3}-[0-9]{3}-[0-9]{3}", ErrorMessage = "Podaj prawidłowy numer")]
